                          ...
                          <div class="content-detail" v-show="this.isShowAdminAccount">
                              ...
                              <div class="row">
                                  <div class="col-md-4" v-show="this.isCreateNew">
                                    <h2>Create New</h2>
                                      <div class="alert alert-primary" role="alert" v-if="errorValidation.length">
                                      ...
                                      <form id="formCreateAdminAccount" @submit.prevent="createAdminAccount()">
                                          <div class="form-group">
                                              ...
                                              <input type="text" class="form-control" id="fullnameAdmin" name="fullnameAdmin" v-model="admin.fullname" placeholder="Fullname" />
                                          </div>
                                          <div class="form-group">
                                              <label for="email"><fa-icon icon="envelope" /> Email</label>
                                              <input type="email" class="form-control" id="emailAdmin" name="emailAdmin" v-model="admin.email" placeholder="Email" />
                                          </div>
                                          <div class="form-group">
                                              <label for="userName"><fa-icon icon="user" /> Username</label>
                                              <input type="text" class="form-control" id="usernameAdmin" name="usernameAdmin" v-model="admin.username" placeholder="Username" />
                                          </div>
                                          <div class="form-group">
                                              <label for="password"><fa-icon icon="unlock" /> Password</label>
                                              <input type="password" class="form-control" id="passwordAdmin" name="passwordAdmin" v-model="admin.password" placeholder="Password" />
                                          </div>
                                          <div class="form-group">
                                              <label for="comfirmPassword"><fa-icon icon="lock" /> Comfirm Password</label>
                                              <input type="password" class="form-control" id="comfirmPasswordAdmin" name="comfirmPasswordAdmin" v-model="admin.comfirmPassword" placeholder="Comfirm Password" />
                                          </div>
                                          <div class="form-group">
                                              <label for="phoneNumber"><fa-icon icon="phone-alt" /> Phone Number</label>
                                              <input type="text" class="form-control" id="phoneNumberAdmin" name="phoneNumberAdmin" v-model="admin.phonenumber" placeholder="Phonenumber" />
                                          </div>
                                          <br />
...
export default {
  ...
  methods: {
    checkIsLogin: function () {
      ...
      axios
        .get(API_URL + "adminInfo?admin=" + this.adminSession.username)
        .then((response) => {
